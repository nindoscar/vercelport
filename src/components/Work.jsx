            ...
            {workData.map((data, index) => (
              <div
                ...
                className="relative pl-12 before:content-[''] before:absolute before:left-0
                  ...
                  before:bg-purple cursor-pointer hover:-translate-y-0.5transition-all duration-300"
              >
                <div className="absolute left-[0.5-rem] top-0 w-6 h-6 rounded-full bg-purple"></div>
                {/* box */}
